...
### Example Exercise (~5 min)
Here is what an end-of-chapter exercise looks like. Each chapter in Part 1 closes with a short set of these. They reuse the chapter's own data and code, carry a rough time estimate in the title, and range from quick recall checks to small open-ended modeling tasks. Worked solutions are collected in @sec-exercise-solutions, but you will get far more out of the exercises if you attempt them before looking.
:::
